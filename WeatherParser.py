...
def weatherRadar(city, state):
    ...
    uri = 'http://api.wunderground.com/api/d1fec7897078849e/animatedradar/q/' + state + '/' + city + '.gif?num=15&timelabel=1&timelabel.x=30&timelabel.y=30&newmaps=1&width=640&height=640'
